...
void AddressTable_impl::refreshAddressTable()
{
    cachedAddressTable.clear();
    {
        ...
        if(includeExternalAccounts)
        {
            ...
            addDonationAddress("The Ocean Cleanup Donations", "PSECCwBvFKCm9WtzDnWVfALgGSgbx2xHAf", "<div>The Ocean Cleanup. In parallel to developing technology<br> to extract plastic from the ocean, we also <br>investigate how we can reuse the material <br> once it is back on shore.<a href='https://cryptodepot.org/the-ocean-cleanup/'>https://cryptodepot.org/the-ocean-cleanup/</a></div>");
            addDonationAddress("World Wildlife Fund Donations", "PG1HxBbH6fjJqx9taUrSqLx2Gmbg7DHc6x", "<div>World Wildlife Fund.<br> World Wildlife Fund The world’s largest <br>independent conservation organization, <br>WWF works in 100 countries and is supported by <br>more than one million members in the <br>United States and close to five million globally<br><a href='https://cryptodepot.org/pnd4pnd/'>https://cryptodepot.org/pnd4pnd/</a></div>");
