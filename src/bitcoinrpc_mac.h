...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop Pandacoin server (and possibly override the detachdb config value).");
...
{ //  name                      function                 safemd  unlocked
  //  ------------------------  -----------------------  ------  --------
    ...
    { "renameaccount",          &renameaccount,          true,   false },
...
void ThreadRPCServer(void* parg)
{
    ...
    RenameThread("pandacoin-rpclist");
...
void ThreadRPCServer3(void* parg)
{
    ...
    RenameThread("pandacoin-rpchand");
...
Array RPCConvertValues(const std::string &strMethod, const std::vector<std::string> &strParams)
{
    ...
    if (strMethod == "sendalert"              && n > 7) ConvertTo<Array>(params[7]);
