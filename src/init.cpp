...
void Shutdown(void* parg)
{
    ...
    RenameThread("pandacoin-shutoff");
...
{
    uiInterface.ThreadSafeMessageBox(str, _("Pandacoin"), CClientUIInterface::OK | CClientUIInterface::MODAL);
    return false;
}

bool static InitWarning(const std::string &str)
{
    uiInterface.ThreadSafeMessageBox(str, _("Pandacoin"), CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
    return true;
}
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: pandacoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: pandacoind.pid)") + "\n" +
